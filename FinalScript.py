...
print("#"*25 + " END Softlink Check on /home/linuxgeek/itcfinal-backups ##" + "\n\n\n" + "#"*25 + " BEGIN ifconfig output ##", file=sbafile)
...
print("#"*25 + " END check apache installed ##" + "\n\n\n" + "#"*25 + " BEGIN Webserver content check ##" + "\n" + "ls -l /var/www", file=sbafile)
